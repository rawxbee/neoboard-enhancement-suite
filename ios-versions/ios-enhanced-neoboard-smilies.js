// ==UserScript==
// @name         Neopets: Enhanced Neoboard Smilies Mobile
// @version      1.4.0
...
.slothsearchbutton {
    text-align:center;
    background-color:#3b54b4;
    color:#fff !important;
    font-family: "Palanquin", 'Arial Bold', sans-serif;
    font-size:12pt;
    line-height:12pt;
    border:1px solid #3b54b4;
    border-radius:10px;
    }
.topicReplyRemainder {
text-align: center;
...
function smile() {
    var smilies = `<div class="extraextrasmilies" style="text-align: center; margin-top:10px;">
...
$(`.replySmilies-neoboards`).html('');
$(`.topicCreateSmilies-neoboards`).html('');
$('.topicReplyRemainder').append(smilies)
$('.topicCreateRemainder').append(smilies)
}
